...
14. Ответ на запрос не поступил в течении установленного врмени
...
|--|-----|
NS-5 |Отказ модуля либо подмена данных визульного позиционирования. В внедрения аппаратной/программной закладке более чем в один из модулей визульного позиционирования, БПЛА может "не заметить" людей и распылить на них вещество.

![Диаграмма доверенных_red_nav](images/subsystem_arch_cam.png)
|--|-----|
NS-6 | Отказ модуля либо подмена данных навигации.  В результате внедрения аппаратной/программной закладке более чем в один из модулей навигации, может быть произведен угон БПЛА.
