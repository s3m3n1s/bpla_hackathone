...
NS-6 | Отказ модуля либо подмена данных навигации.  В результате аппаратной/программной закладке более, чем в одном из модулей навигации, может быть произведен угону БПЛА.
