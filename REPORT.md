...
| Номер сценария | Описание |
|--|-----|
NS-5 |Отказ модуля либо подмена данных визульного позиционирования. В внедрения аппаратной/программной закладки более чем в один из модулей визульного позиционирования, БПЛА может "не заметить" людей и распылить на них вещество.
