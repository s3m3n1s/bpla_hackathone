...
Данные сценарии можно промоделировать с использованием мокирующих сенсоры функций, используя библиотеку pytest.
...
Для моделирования можно поднять второй экземпляр контейнера сервера и послеать http-response на дрон
...
Политики безопасности в виде кода представлены в [файле](./monitor/policies.py)


Для запуска системы набора модулей необходимо:
